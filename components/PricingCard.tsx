...
export const PricingCard: React.FC<PricingCardProps> = ({ pkg, index }) => {
  return (
    <div className={`min-w-full md:min-w-0 md:w-full md:max-w-6xl flex-shrink-0 snap-center relative flex flex-col p-6 md:p-8 bg-white rounded-2xl border ${pkg.isPopular ? 'border-[#0B2338] shadow-xl scale-100 md:scale-105 z-10' : 'border-slate-200 shadow-sm'} transition-all duration-300 h-full`}>
