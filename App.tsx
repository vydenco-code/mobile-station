...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm pt-safe">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 md:py-4 space-y-3 md:space-y-4">
          ...
          <div className="flex overflow-x-auto no-scrollbar gap-2 md:gap-3 pb-2 -mx-4 px-4 md:mx-0 md:px-0 scroll-pl-4">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        {/* Pricing Grid - Flex on mobile (with peek), Flex centered on desktop */}
        <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-6 -mx-4 px-4 md:flex md:flex-wrap md:justify-center md:gap-8 md:pb-0 md:mx-0 md:px-0 md:overflow-visible items-stretch scroll-pl-4">
      ...
      <footer className="bg-white border-t border-slate-200 py-8 text-slate-500 text-sm md:text-base pb-safe">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
             <a href="tel:9903799675" className="flex items-center gap-2 hover:text-[#0B2338] transition-colors p-2 md:p-0">
               <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                 <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
               </svg>
               <span>9903799675</span>
             </a>
             <a href="mailto:vyden.co@gmail.com" className="flex items-center gap-2 hover:text-[#0B2338] transition-colors p-2 md:p-0">
               <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
